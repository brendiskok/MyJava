...
public class RandSentence46 {
	public static void main (String[] srgs) {
		...
		String[] seq1 = {"добрый", "удачный", "веселый", "познавательный" };
		String[] seq2 = {", теплый ", ", счастливый ", ", потрясающий"};
		String[] seq3 = {", солнечный!", ", суперский!", ", все получится!"};
		...
		System.out.println( "Твой день сегодня будет " + seq1[rand1] + seq2[rand2] + seq3[rand3]);
